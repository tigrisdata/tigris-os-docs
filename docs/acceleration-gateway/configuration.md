...
| `TAG_CACHE_PARQUET_OPTIMIZATION`            | Cache a parquet object's metadata blocks ahead of the reader, on read and on write. Requires block caching. See [Parquet optimization](./parquet-optimization.md) | `false`                  |
