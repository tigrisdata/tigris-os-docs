...
```mermaid
%%{init: {'theme': 'base', 'flowchart': {'padding': 8, 'nodeSpacing': 25, 'rankSpacing': 35}, 'themeVariables': {'primaryColor': '#142229', 'primaryTextColor': '#c8d6de', 'primaryBorderColor': '#1e3340', 'lineColor': '#62FEB5', 'secondaryColor': '#101c24', 'tertiaryColor': '#0e1920', 'edgeLabelBackground': 'transparent', 'clusterBkg': '#0e1920', 'clusterBorder': '#1e3340', 'fontFamily': 'sans-serif', 'fontSize': '13px', 'background': '#0e1920', 'textColor': '#8fa3b0', 'nodeBorder': '#1e3340'}}}%%
flowchart LR
    classDef app fill:#142229,stroke:#2a4050,color:#c8d6de,stroke-width:1.2px
    classDef tag fill:#62FEB5,stroke:#62FEB5,color:#0A171E,stroke-width:1.2px
    classDef cache fill:#142229,stroke:#62FEB5,color:#62FEB5,stroke-width:1px
    classDef upstream fill:#101c24,stroke:#62FEB5,color:#62FEB5,stroke-width:1.5px
...
%%{init: {'theme': 'base', 'flowchart': {'padding': 8, 'nodeSpacing': 25, 'rankSpacing': 35}, 'themeVariables': {'primaryColor': '#142229', 'primaryTextColor': '#c8d6de', 'primaryBorderColor': '#1e3340', 'lineColor': '#62FEB5', 'secondaryColor': '#101c24', 'tertiaryColor': '#0e1920', 'edgeLabelBackground': 'transparent', 'clusterBkg': '#0e1920', 'clusterBorder': '#1e3340', 'fontFamily': 'sans-serif', 'fontSize': '13px', 'background': '#0e1920', 'textColor': '#8fa3b0', 'nodeBorder': '#1e3340'}}}%%
flowchart LR
    classDef client fill:#142229,stroke:#2a4050,color:#c8d6de,stroke-width:1.2px
    classDef tag fill:#62FEB5,stroke:#62FEB5,color:#0A171E,stroke-width:1.2px
    classDef upstream fill:#101c24,stroke:#62FEB5,color:#62FEB5,stroke-width:1.5px
...
%%{init: {'theme': 'base', 'flowchart': {'padding': 8, 'nodeSpacing': 25, 'rankSpacing': 35}, 'themeVariables': {'primaryColor': '#142229', 'primaryTextColor': '#c8d6de', 'primaryBorderColor': '#1e3340', 'lineColor': '#62FEB5', 'secondaryColor': '#101c24', 'tertiaryColor': '#0e1920', 'edgeLabelBackground': 'transparent', 'clusterBkg': '#0e1920', 'clusterBorder': '#1e3340', 'fontFamily': 'sans-serif', 'fontSize': '13px', 'background': '#0e1920', 'textColor': '#8fa3b0', 'nodeBorder': '#1e3340'}}}%%
flowchart TB
    classDef infra fill:#142229,stroke:#2a4050,color:#c8d6de,stroke-width:1.2px
    classDef node fill:#62FEB5,stroke:#62FEB5,color:#0A171E,stroke-width:1.2px
