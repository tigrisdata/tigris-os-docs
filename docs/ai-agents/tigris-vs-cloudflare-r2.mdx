---
description:
  "Tigris vs Cloudflare R2: feature comparison, pricing, global distribution,
  and migration guide. Choose the right S3-compatible object storage."
keywords:
  [
    tigris vs r2,
...
zero egress fees. The key differences: Tigris provides automatic global
distribution and bucket forks. R2 provides Workers integration and is tied to
