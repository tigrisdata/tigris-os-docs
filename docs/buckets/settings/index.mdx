...
migration. The source bucket you migrate from is called a shadow bucket, and it
has to live outside Tigris — another Tigris bucket is not a valid source. Tigris
