...
7. At **T6**, Object 3 in Bucket B is updated to `foo`.
8. At **T7**, Snapshot B1 is created, preserving Object 3’s state.
9. At **T8**, **Bucket C is forked from Bucket B**. It starts with Object 1
   (`baz`).
10. At **T9**, Object 1 remains unchanged in Bucket C.
11. At **T10**, **Bucket D is forked from Bucket B**.
12. At **T11**, Object 2 in Bucket D is updated to `quux`.
13. At **T12**, Object 1 is added to Bucket D with value `baz`.
