...
A location change applies to new objects only. Existing objects stay in their
current locations. Tigris does not move existing objects to the new locations.
