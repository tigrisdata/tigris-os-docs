...
<!-- prettier-ignore -->
:::note
`--endpoint` has to name a provider outside Tigris. A Tigris endpoint is
rejected with `Migration source cannot be Tigris endpoint`; to copy between
Tigris buckets, [fork the bucket](/docs/buckets/snapshots-and-forks/) instead.
:::
