...
import mcpStyles from "!!raw-loader!./get-started-styles.css";
...
This guide will have you storing and retrieving objects in minutes — pick the
tool that fits your workflow.
...
[Tigris dashboard](https://console.storage.dev/createaccesskey):
...
{/* prettier-ignore */}
<div className="get-started-mcp-btns">
<a href="cursor://anysphere.cursor-deeplink/mcp/install?name=tigris&config=eyJ1cmwiOiJodHRwczovL21jcC5zdG9yYWdlLmRldi9tY3AifQ%3D%3D">Add to Cursor</a>
<a href="vscode:mcp/install?%7B%22name%22%3A%22tigris%22%2C%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fmcp.storage.dev%2Fmcp%22%7D">Add to VS Code</a>
</div>
