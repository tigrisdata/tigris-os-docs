...
as a supported object storage provider. Using the multimodal lakehouse features
of LanceDB, starts with installing the open-source Python package `geneva`:

```text
pip install geneva
```

And importing your LanceDB table:
