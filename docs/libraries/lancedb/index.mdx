...
[works with LanceDB](/docs/libraries/lancedb/) because Tigris exposes the S3
API, which LanceDB can use to read and write data. All you need to do is change
out the credentials and endpoints.
