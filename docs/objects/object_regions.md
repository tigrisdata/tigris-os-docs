...
| Use-Case               | Header                 |
| ---------------------- | ---------------------- |
| Restrict to Washington | "X-Tigris-Regions:ord" |
...
Restricting your bucket data to a single region ensures that all requests are
directed there, enabling strong consistency for your bucket.
...
Restricting your bucket data to a multiple regions also means that all requests
