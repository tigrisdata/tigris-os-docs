...
| Section                                          | Description                                     |
| ------------------------------------------------ | ----------------------------------------------- |
| [Performance Metrics](./metrics.mdx)             | Detailed methodology and benchmark setup        |
| [Comparison: AWS S3](./aws-s3.mdx)               | Head-to-head performance comparison with AWS S3 |
| [Comparison: Cloudflare R2](./cloudflare-r2.mdx) | Head-to-head performance comparison with R2     |
| [Model Training on Tigris](./model-training.mdx) | ML training with TAG caching proxy on Tigris    |
| [Benchmark Summary](./summary.mdx)               | Complete results and conclusions                |
