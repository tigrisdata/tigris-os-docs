...
Three fields on the Partner API control access: `user_role` scopes management
operations, `buckets_roles` scopes S3 bucket operations, and `access_key_scope`
controls whether a key receives default S3 and IAM operations. See
