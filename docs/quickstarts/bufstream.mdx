...
returning you to a prompt after all services start.
...
Produce to the topic Now that you've created a topic, let's write some data. In
the example repo, we've included a sample message in messages.txt. Run the
