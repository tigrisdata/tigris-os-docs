...
open formats like Parquet, in object storage. For a walkthrough, see
...
[Access Key guide](https://www.tigrisdata.com/docs/iam/manage-access-key/) to
create one.
...
- [Get your data ducks in a row with DuckLake](https://www.tigrisdata.com/blog/ducklake/)
  — a guided tour of running a DuckLake lakehouse on Tigris.
- [Data Time Travel with DuckLake and Tigris](https://www.tigrisdata.com/blog/ducklake-time-travel/)
...
- [Fending off scrapers with Tigris and DuckDB](https://www.tigrisdata.com/blog/anubis/)
  — a real-world example of analyzing honeypot logs in Tigris with DuckDB.
