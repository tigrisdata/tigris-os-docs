...
- **[Blazing fast](https://www.tigrisdata.com/blog/benchmark-small-objects/):**
  Tigris is 5.3x faster than S3 and 86.6x faster than R2 for small object reads.
  If your workload depends on reading lots of small objects—logs, AI features,
  or massive number of tiny files—this matters.
