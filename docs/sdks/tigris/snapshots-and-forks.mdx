...
This page covers using snapshots and forks with the Tigris JavaScript SDK. For
an overview of the concepts, see [Snapshots](/docs/snapshots) and
[Forks](/docs/forks). For using snapshots and forks with other SDKs (Go,
Python), see [Bucket Snapshots and Forks](/docs/buckets/snapshots-and-forks).
...
A fork is a new bucket created from an existing one, sharing data without
duplication.
