...
<center style={{ marginLeft: "auto", marginRight: "auto" }}>
  <img
    src={require("/img/listing-objects-in-snapshot.png").default}
    style={{ maxWidth: "20rem", minWidth: "4rem" }}
    alt="Snapshot dropdown view"
  />
</center>
...
No. Object expiration is not supported on snapshot-enabled buckets.
...
[this section](/docs/buckets/snapshots-and-forks/#using-object-versioning-apis)
for more details.
