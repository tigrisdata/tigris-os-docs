...
GeeseFS does not obfuscate the objects in the bucket (unlike JuiceFS). This
means you can access the objects directly via the S3-compatible API using the
standard S3 SDKs, tools, and libraries, as well as via the GeeseFS filesystem.
