...
Aftern testing filesystems for performance and reliability, we recommend [GeeseFS](https://github.com/yandex-cloud/geesefs). GeeseFS lets you mount S3 buckets to
your local Linux system. Since Tigris is S3-compatible, you can use GeeseFS to mount any Tigris bucket as if it was a normal Linux filesystem.
...
Create a new access key with edit permissions on your target bucket as described in the guide [here](placeholder). Configure the aws-cli to utilize the credentials as described in the guide [here](https://www.tigrisdata.com/docs/sdks/s3/aws-cli/).
